...
- [01 - Arquitetura Geral](./01-arquitetura.md)
- [02 - Modelagem de Dados](./02-modelagem-de-dados.md)
- [03 - Banco PostgreSQL](./03-banco-postgresql.md)
- [04 - Backend Node.js](./04-backend-nodejs.md)
- [05 - Frontend Vue.js](./05-frontend-vue.md)
- [06 - Autenticacao](./06-autenticacao.md)
- [07 - Modulo Membros](./07-modulo-membros.md)
- [08 - Cargos e Permissoes](./08-cargos-e-permissoes.md)
- [09 - Modulo Financeiro](./09-modulo-financeiro.md)
- [10 - Roadmap MVP](./10-roadmap-mvp.md)
- [11 - Backoffice](./11-backoffice.md)

## Backoffice

Documentacao detalhada da camada administrativa da plataforma:
...
O arquivo [11 - Backoffice](./11-backoffice.md) permanece como resumo executivo e ponto de entrada rapido. Os detalhes tecnicos e operacionais agora ficam distribuídos nos documentos especificos acima.
